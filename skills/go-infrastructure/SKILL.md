...
description: Declare cloud infrastructure with Encore Go including databases, Pub/Sub topics and subscriptions, cron jobs, object storage buckets, and secrets. Use when setting up infrastructure resources, background jobs, message queues, file storage, or environment configuration. Keywords: go, golang, database, postgres, pubsub, topic, subscription, cron, scheduler, bucket, storage, secret, infrastructure, queue.
---
