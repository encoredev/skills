---
name: encore-go-api
description: Create API endpoints with Encore Go using annotations. Use when building REST APIs, handling HTTP requests, defining request/response types, or implementing raw endpoints for webhooks. Keywords: go, golang, api, endpoint, route, handler, request, response, REST, HTTP, webhook.
---
