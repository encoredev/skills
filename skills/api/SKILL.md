---
name: encore-api
description: Create type-safe API endpoints with Encore.ts. Use when building REST APIs, handling HTTP requests, defining request/response types, working with headers, query parameters, path parameters, or implementing raw endpoints for webhooks. Keywords: api, endpoint, route, handler, request, response, REST, HTTP, webhook.
---
