---
name: encore-migrate
description: Migrate existing Node.js backend code to Encore.ts. Use when converting Express, Fastify, Hono, Koa, or vanilla Node.js applications to Encore patterns. Keywords: migrate, convert, express, fastify, hono, koa, node, refactor, port, transition.
---
