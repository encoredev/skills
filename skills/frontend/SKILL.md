...
description: Connect frontend applications to Encore backends. Use when generating API clients, configuring CORS, or integrating with React, Next.js, or other frontend frameworks. Keywords: frontend, client, react, nextjs, cors, fetch, api client, typescript client, generate.
---
