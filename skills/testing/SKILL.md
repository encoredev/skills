---
name: encore-testing
description: Test Encore.ts APIs and services. Use when writing unit tests, integration tests, or testing API endpoints. Keywords: test, testing, unit test, integration, vitest, jest, mock, api test.
---
