...
description: Get started with Encore.ts - create new projects, understand project structure, and run your first app. Use when starting a new Encore project or learning the basics. Keywords: new, create, init, setup, start, project, hello world, tutorial, beginner.
---
