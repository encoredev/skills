...
description: Work with PostgreSQL databases in Encore Go including queries, migrations, and database operations. Use when writing database queries, creating migrations, or handling database operations. Keywords: go, golang, database, postgres, sql, query, migration, insert, select, update, delete, sqldb.
---
