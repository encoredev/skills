...
description: Review code for Encore.ts best practices and common mistakes. Use when reviewing pull requests, auditing existing code, or checking for Encore-specific anti-patterns. Keywords: review, audit, check, lint, best practices, anti-pattern, mistake, bug.
---
