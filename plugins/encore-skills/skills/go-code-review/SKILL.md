...
description: Review code for Encore Go best practices and common mistakes. Use when reviewing pull requests, auditing existing code, or checking for Encore-specific anti-patterns. Keywords: go, golang, review, audit, check, lint, best practices, anti-pattern, mistake, bug.
---
