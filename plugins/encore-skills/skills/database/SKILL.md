...
description: Work with PostgreSQL databases in Encore.ts including queries, migrations, and ORM integration. Use when writing database queries, creating migrations, setting up Drizzle or Prisma, or handling database operations. Keywords: database, postgres, sql, query, migration, drizzle, prisma, orm, insert, select, update, delete.
---
