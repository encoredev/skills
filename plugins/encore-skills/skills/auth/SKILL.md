---
name: encore-auth
description: Implement authentication in Encore.ts applications. Use when protecting endpoints, creating auth handlers, setting up API gateways, or accessing user identity. Keywords: auth, authentication, login, token, jwt, session, gateway, protect, authorize, identity.
---
