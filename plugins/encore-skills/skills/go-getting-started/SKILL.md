...
description: Get started with Encore Go - create new projects, understand project structure, and run your first app. Use when starting a new Encore Go project or learning the basics. Keywords: go, golang, new, create, init, setup, start, project, hello world, tutorial, beginner.
---
