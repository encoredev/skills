---
name: encore-go-auth
description: Implement authentication in Encore Go applications. Use when protecting endpoints, creating auth handlers, or accessing user identity. Keywords: go, golang, auth, authentication, login, token, jwt, session, protect, authorize, identity.
---
