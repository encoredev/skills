...
description: Structure and organize Encore Go services and applications. Use when creating new services, deciding on service boundaries, organizing code, or planning application architecture. Keywords: go, golang, service, microservice, monolith, structure, architecture, organize, module, package.
---
