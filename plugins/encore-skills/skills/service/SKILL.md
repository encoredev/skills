---
name: encore-service
description: Structure and organize Encore.ts services and applications. Use when creating new services, deciding on service boundaries, organizing code, or planning application architecture. Keywords: service, microservice, monolith, structure, architecture, organize, module, encore.service.ts.
---
